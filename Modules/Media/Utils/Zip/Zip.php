...
class Zip
{
     ...
     * @throws Exception
     */
    protected function createArchiveFile(string $pathToZip)
    {
    ...
    protected function addDir($pathToDir)
    {
        ...
        foreach ($this->file->files($pathToDir) as $file) {
            $this->addFile($pathToDir . '/' . basename((string)$file));
        }
     ...
     * @return $this Zipper instance
     */
    public function addString(string $filename, string $content)
    {
